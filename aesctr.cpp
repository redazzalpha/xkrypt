...
// virtual methods
std::string AesCTR::getModeName() const
{
    return AesCTR::ModeName;
}

// slots
string AesCTR::encryptText(const string& plain, Keygen* keygen, const Encoding encoding) noexcept(false)
{
    std::string cipher = "";
    try {
...
string AesCTR::decryptText(const string& cipher, Keygen* keygen, const Encoding encoding) noexcept(false)
{
    std::string recover;
    try {
        const SecByteBlock& key = keygen->getKey();
...
void AesCTR::encryptFile(vector<string> paths, Keygen* keygen, const Encoding encoding)
{
    string output;
    string filenameEnc;
    try {
...
void AesCTR::decryptFile(vector<string> paths, Keygen* keygen, const Encoding encoding)
{
    string output;
    string filenameDec;
    try {
