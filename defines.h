...
#define XKRYPT_IV_SIZE 16
#define XKRYPT_SALT_SIZE 32
#define XKRYPT_REF_SIZE_UNIT 6
#define XKRYPT_REF_SIZE \
    XKRYPT_REF_SIZE_UNIT/* + \
    XKRYPT_SALT_SIZE + \
    XKRYPT_IV_SIZE*/
#define XKRYPT_KEY_REF_SIZE 3
#define XKRYPT_REF_VERSION 0x01
#define XKRYPT_REF_MODEL 0x24
#define XKRYPT_REF_DECFNAME 0X01
#define XKRYPT_REF_NOTDECFNAME 0x00
#define XKRYPT_TAG_SIZE 16
