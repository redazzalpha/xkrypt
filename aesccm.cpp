...
void AesCCM::encryptFile(const KeyGen& keygen, fstream* file, const Encoding encoding) noexcept(false)
{

}
void AesCCM::decryptFile(const KeyGen& keygen, fstream* file, const Encoding encoding) noexcept(false)
{
