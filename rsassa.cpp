...
bool RsaSSA::encryptFile(const KeyGen& keygen, const Encoding encoding) noexcept(false)
{

}
bool RsaSSA::decryptFile(const KeyGen& keygen, const Encoding encoding) noexcept(false)
{
