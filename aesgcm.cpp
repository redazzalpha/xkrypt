...
bool AesGCM::encryptFile(const KeyGen& keygen, const Encoding encoding) noexcept(false)
{

}
bool AesGCM::decryptFile(const KeyGen& keygen, const Encoding encoding) noexcept(false)
{
